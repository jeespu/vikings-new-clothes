...
background1.src = 'Graphics/BearGame/background.png';
background2.src = 'Graphics/BearGame/background.png';
// variables for pause:
var pauseButton;
...
function init() {
    ...
    $("#gameName").css({"display":"block"}); // REMOVE THIS IF WE DON'T WANT THE TEXTBOX ABOVE THE GAME
    ...
    // audio = new Audio('Music/BearChase.mp3');
    // audio.loop = true;
    // audio.play();
...
function update() {
    ...
    if (player.win) {
        ...
        if (!winHappened) {
            ...
            player.width = 67;
            player.height = 100;
            player.playerImg1.src = 'Graphics/BearGame/folke3.png';
            player.playerImg2.src = 'Graphics/BearGame/folke3.png';
            ax.axImg.src = 'Graphics/BearGame/stump.png';
            doPause3s();
            winHappened = true;
        }
    }
...
function switchSound() {
    ...
    if (wrap.className === 'on') {
        chaseTheme.mute(true);
        wrap.className = 'off';
    } else {
        chaseTheme.mute(false);
        wrap.className = 'on';
    }
}
